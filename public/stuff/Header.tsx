...
import { ShoppingCart, User, Search, Menu, X, Cpu, LogOut, Settings, MessageCircle } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* Only show cart/chat/user menu for non-admin users */}
              ...
              {currentUser ? (
                ...
                <div className="flex space-x-2">
                  ...
                  <Link to="/signup" className="flex-1">
                    <Button variant="glow" className="w-full" onClick={() => setIsMobileMenuOpen(false)}>
                      {t('header.signup')}
                    </Button>
                  </Link>
                </div>
